...
public class TestDb {
    ...
    public void testReviewsTable() {
        ...
        // Create ContentValues you want to insert
        ContentValues testValues = TestUtilities.createReviewsTestValues();

        long movieRowId = db.insert(MovieContract.ReviewEntry.TABLE_NAME, null, testValues);
        ...
        // test that the correct values were inserted
        Cursor cursor = db.query(
                MovieContract.ReviewEntry.TABLE_NAME, // table name
                null, // all columns
                null, // columns for where clause
                null, // values for where clause
                null, // columns to group by
    ...
    public void testFavoritesTable() {
        ...
        // Create ContentValues you want to insert
        ContentValues testValues = TestUtilities.createFavoritesTestValues();
        ...
        // test that the correct values were inserted
        Cursor cursor = db.query(
                MovieContract.FavoriteEntry.TABLE_NAME, // table name
                null, // all columns
                null, // columns for where clause
                null, // values for where clause
                null, // columns to group by
